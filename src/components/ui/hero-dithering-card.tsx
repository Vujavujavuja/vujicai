        ...
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link
                href="/blog/"
                className="group relative inline-flex h-14 items-center justify-center gap-3 overflow-hidden rounded-full border border-border bg-background/50 backdrop-blur-sm px-12 text-base font-medium text-foreground transition-all duration-300 hover:bg-background hover:scale-105 active:scale-95"
              >
                Read the Blog
              </Link>
            </div>
